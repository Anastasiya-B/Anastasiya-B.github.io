    ...
    for (var i = 0; i < keys.length; i++) {
        keys[i].onclick = function (e) {
            ...
            if (btnVal === 'C') {
                ...
                var _lastChar = inputVal[inputVal.length - 1];
                if (inputVal != '' && operators.indexOf(_lastChar) == -1) input.innerHTML += btnVal;else if (inputVal == '' && btnVal == '-') input.innerHTML += btnVal;
                if (operators.indexOf(_lastChar) > -1 && inputVal.length > 1) {
